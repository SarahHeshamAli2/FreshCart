...
<CategorySlider/>
    ...
    <div className="container my-5 py-5">
      <h4 id='featured' className='mt-5 mb-0 fw-bolder'   > Featured products</h4>
        <div className="dropdown float-end mt-2">
  
        {isLoading?<Loading/> :<button className="btn btn-outline-success dropdown-toggle sort" type="button" data-bs-toggle="dropdown" aria-expanded="false">
   Sort By
